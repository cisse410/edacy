...
const handleSubmit = async () => {
  ...
  try {
    ...
    const result = await productStore.createProduct(formattedProduct)
  ...
  <div class="py-10">
    <header>
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold leading-tight text-gray-900">Création d'un produit</h1>
      </div>
    </header>
    <main>
          ...
          <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="px-4 py-5 sm:p-6">
              <form @submit.prevent="handleSubmit" class="space-y-6">
                <!-- Error display -->
                <div v-if="productStore.error" class="rounded-md bg-red-50 p-4">
                  <div class="flex">
